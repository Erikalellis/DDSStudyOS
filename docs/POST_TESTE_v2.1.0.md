# DDS StudyOS - Post pronto para Facebook (v2.1.0)

## Texto principal (copiar e colar)
...
Se encontrar qualquer erro, envie:
1. Versao do Windows.
...
- Foto 2: Tela de cursos/dashboard com dados reais.
- Foto 3: Tela de materiais/agenda para mostrar uso no dia a dia.
