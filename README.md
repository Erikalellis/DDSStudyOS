...
## Status do produto
- Build estável validada localmente: `3.2.2`
- Próximo ciclo incremental (DLC) em preparação: `3.2.3`
- Última tag enviada ao repositório: `v3.2.1`
- Último release GitHub consolidado: `3.2.1`
